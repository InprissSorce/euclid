...
class Pen():
    ...
    def forward(self, dist):
        ...
        stop = (start[0] + delta_x), (start[1] + delta_y)
        if self.fill:
            self.vertices.append(stop)
            Pen.line(self, start, stop)
        elif self.isDown():
    ...
    def circle(self, radius):
        ...
        int_position = to_int(self.position[0]), to_int(self.position[1])
        pygame.gfxdraw.aacircle(page, *int_position, radius, self.color)
        Pen.render()
        time.sleep(self.delay)
    ...
    def disc(self, radius, fillColor = None):
        ...
        if fillColor is not None:
            pygame.gfxdraw.filled_circle(page, *int_position, radius, fillColor)
            Pen.circle(self, radius)
        else:
            pygame.gfxdraw.filled_circle(page, *int_position, radius, self.color)
        Pen.render()
        time.sleep(self.delay)
